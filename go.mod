module github.com/TykTechnologies/momo
...
require (
	...
	github.com/kevholditch/gokong v1.9.1
...
replace (
	github.com/TykTechnologies/ara/controller => ../../controller
	github.com/TykTechnologies/momo/pkg => ./pkg
	gopkg.in/ory-am/dockertest.v3 => github.com/ory/dockertest v3.3.4+incompatible
)
